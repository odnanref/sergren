 ...
 */
final class Version20180822214110 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE app_users CHANGE username username VARCHAR(254) NOT NULL, CHANGE password password VARCHAR(254) NOT NULL, CHANGE role role VARCHAR(254) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE app_users CHANGE username username VARCHAR(25) NOT NULL COLLATE utf8mb4_unicode_ci, CHANGE password password VARCHAR(64) NOT NULL COLLATE utf8mb4_unicode_ci, CHANGE role role VARCHAR(25) NOT NULL COLLATE utf8mb4_unicode_ci');
